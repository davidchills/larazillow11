<template>
	<Box>
		<template #header>Make an Ofer</template>
		
		<div>
			<form @submit.prevent="makeOffer">
				<input v-model.number="form.amount" type="text" placeholder="Enter your offer" />
				<input 
				...
				<button type="submit" class="btn-outline w-full mt2 text-sm">Make an Offer</button>
			</form>
		</div>
		...
		<div class="flex justify-between mt-2">
			...
			<div>
				<Price :price="difference" class="text-2xl font-bold" />
			</div>
